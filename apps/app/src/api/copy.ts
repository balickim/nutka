...
export const errorCopy: Record<string, string> = {
  ...
  invalid_practice_task: "Zadanie potrzebuje nazwy do 200 znaków. Czas może mieć od 1 do 120 minut.",
  invalid_practice_plan: "Sprawdź zadania. Każde nowe zadanie potrzebuje nazwy, a czas może mieć od 1 do 120 minut.",
  invalid_practice_session: "Sprawdź wpis. Dzień może być najwyżej 14 dni wstecz, czas od 1 do 240 minut, a komentarz do 500 znaków.",
  practice_session_locked: "Ten wpis ma więcej niż 7 dni i nie można go już usunąć.",
