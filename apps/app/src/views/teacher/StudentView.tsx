// Presents one learner's commercial workspace and materials, loading that learner's data only and refusing a foreign assignment.
...
import { MaterialsTab } from "./student/MaterialsTab";
